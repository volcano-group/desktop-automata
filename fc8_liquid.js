...
import us from './fc8_UsLiquid_map.json'   
import si from './fc8_SiLiquid_map.json'   

/*//set speed
robot.setKeyboardDelay(350)
robot.setMouseDelay(100)*/

exports.UsLiquid = function(object) {
...
exports.SiLiquid = function(object) {
    //select pressure unit
    let i = 0
    robot.keyTap('enter')
    for(i=0; i<13; i++){
    ...
    for(i=0; i<si.Pressure.indexOf(object.pressureUnit); i++){
        robot.keyTap('up')
    }
    for(i=0; i<11; i++){
        robot.keyTap('tab')
    ...
    for(i=0; i<si.Differential.indexOf(object.differentialUnit); i++){
        robot.keyTap('down')
    }
    for(i=0; i<11; i++){
        robot.keyTap('tab')
    ...
    for(i=0; i<si.Temperature.indexOf(object.temperatureUnit); i++){
        robot.keyTap('up')
    }
    for(i=0; i<11; i++){
        robot.keyTap('tab')
    ...
    let ind = si.Flow.Unit.indexOf(object.flowUnit)
    let indStd = si.Flow.Unit.indexOf('Base Litre (Cubic Decimetres)')
    if(ind>indStd){
        for(i=0; i<ind-indStd; i++){
            robot.keyTap('down')
        }
    ...
    robot.keyTap('tab')
    for(i=0; i<si.Flow.Time.indexOf(object.flowUnitTime); i++){
        robot.keyTap('down')
    }
    for(i=0; i<11; i++){
        robot.keyTap('tab')
    ...
    for(i=0; i<si.Density.Mass.indexOf(object.densityMassUnit); i++){
        robot.keyTap('down')
    }
    robot.keyTap('tab')
    for(i=0; i<si.Density.Volume.indexOf(object.densityVolumeUnit); i++){
        robot.keyTap('down')
    }
    for(i=0; i<11; i++){
        robot.keyTap('tab')
    ...
    for(i=0; i<si.DensityMethod.indexOf(object.densityMethod); i++){
        robot.keyTap('down')
    }
    for(i=0; i<11; i++){
        robot.keyTap('tab')
    ...
    for(i=0; i<si.Viscosity.indexOf(object.viscosityUnit); i++){
        robot.keyTap('down')
    }
    for(i=0; i<11; i++){
        robot.keyTap('tab')
    ...
    for(i=0; i<si.Dimensional.indexOf(object.dimensionalUnit); i++){
        robot.keyTap('down')
    }
    for(i=0; i<11; i++){
        robot.keyTap('tab')
